...
import { n as auth } from "./server-PDM6ERpB.mjs";
import { t as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BKk0mUro.js
...
var styles_default = "/assets/styles-DMgVTV26.css";
var APP_NAME = "Synq";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "协同监控 Claude Code 与 Codex 的模型用量，实时换算订阅额度。"
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-Ckuxmezg.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-Bb0iKmwi.mjs");
